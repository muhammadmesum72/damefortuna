...
import Team1 from "../assets/cronos-cro-logo.png";
import Team2 from "../assets/witness.png";
import Team4 from "../assets/alchemy.png";

const Partners = () => {
  const partners = [Team1, Team2, Team4];
  return (
    <div className="pt-36">
      <div className="w-full text-xl md:text-3xl text-center ">
        Partners and Friends
      </div>
      <div
        id="partners"
        className="grid grid-cols-2 items-center md:flex  w-full items-center justify-around gap-6 md:gap-0  h-fit pt-12 "
      >

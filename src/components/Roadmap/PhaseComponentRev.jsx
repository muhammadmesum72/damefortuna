...
const PhaseComponentRev = ({ info, id, icon }) => {
  return (
    <div
      data-aos="fade-right"
      className="flex items-center flex-col-reverse md:flex-row-reverse justify-center gap-12  text-3xl  w-fit mx-auto"
    >
...
export default PhaseComponentRev;
